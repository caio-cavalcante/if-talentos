...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($tipo_cadastro == 'aluno') {
        ...
        $stmt_matricula = $pdo->prepare("SELECT id_aluno FROM aluno WHERE matricula = ?");
        $stmt_matricula->execute([$matricula]);
        if ($stmt_matricula->fetch()) {
    ...
    <div class="container">
        <div class="register-form-container">
            ...
            <div id="user-type-selector">
                <p>Selecione o tipo de perfil que deseja criar:</p>
            ...
            <form id="form-aluno" action="cadastro.php" method="POST" class="register-form" style="display:none;">
                ...
                <div class="form-group"><input type="tel" name="tel" placeholder="Telefone" required value="<?php echo htmlspecialchars($old_input['tel'] ?? ''); ?>"></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" name="matricula" placeholder="Matrícula" required value="<?php echo htmlspecialchars($old_input['matricula'] ?? ''); ?>">
                    <?php if(isset($errors['matricula'])): ?><span class="error-message"><?php echo $errors['matricula']; ?></span><?php endif; ?>
                </div>
                <div class="form-group">
            ...
            <form id="form-empresa" action="cadastro.php" method="POST" class="register-form" style="display:none;">
                ...
                <div class="form-group"><input type="tel" name="tel" placeholder="Telefone Comercial" value="<?php echo htmlspecialchars($old_input['tel'] ?? ''); ?>"></div>
                <div class="form-group">
                    <input type="text" name="login" placeholder="Login de Acesso" required value="<?php echo htmlspecialchars($old_input['login'] ?? ''); ?>">
                    <?php if(isset($errors['login'])): ?><span class="error-message"><?php echo $errors['login']; ?></span><?php endif; ?>
                </div>
                ...
                <div class="form-group"><input type="text" name="nome_fant" placeholder="Nome Fantasia da Empresa" required value="<?php echo htmlspecialchars($old_input['nome_fant'] ?? ''); ?>"></div>
                <div class="form-group">
